...
export default function GuaranteeBonsaiFurniturePage() {
  ...
  useSWR(
    'fetchGuaranteeBonsaiFurnitureList',
    fetchGuaranteeBonsaiFurnitureList
  );

  useEffect(() => {
    fetchGuaranteeBonsaiFurnitureList();
  }, [fetchGuaranteeBonsaiFurnitureList, valueFilter]);
  ...
  return (
    <div>
      <CMSCategory
        ...
        columns={columns}
        // refeshWhenNotValue={'fetchGuaranteeBonsaiFurnitureList'}
      />
      <Modal
        styles={{
          mask: {
