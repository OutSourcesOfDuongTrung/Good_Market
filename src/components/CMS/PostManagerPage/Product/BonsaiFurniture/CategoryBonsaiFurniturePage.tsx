...
export default function CategoryBonsaiFurniturePage() {
  ...
  useSWR('fetchCategoryBonsaiFurnitureList', fetchCategoryBonsaiFurnitureList);

  useEffect(() => {
    fetchCategoryBonsaiFurnitureList();
  }, [fetchCategoryBonsaiFurnitureList, valueFilter]);
  ...
  return (
    <div>
      <CMSCategory
        ...
        columns={columns}
        // refeshWhenNotValue={'fetchCategoryBonsaiFurnitureList'}
      />
      <Modal
        styles={{
          mask: {
