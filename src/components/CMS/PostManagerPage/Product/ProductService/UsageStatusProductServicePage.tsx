...
export default function UsageStatusProductServicePage() {
  ...
  useSWR(
    'fetchUsageStatusProductServiceList',
    fetchUsageStatusProductServiceList
  );

  useEffect(() => {
    fetchUsageStatusProductServiceList();
  }, [fetchUsageStatusProductServiceList, valueFilter]);
  ...
  return (
    <div>
      <CMSCategory
        ...
        columns={columns}
        // refeshWhenNotValue={'fetchUsageStatusProductServiceList'}
      />
      <Modal
        styles={{
          mask: {
