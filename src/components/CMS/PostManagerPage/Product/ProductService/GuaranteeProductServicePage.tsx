...
export default function GuaranteeProductServicePage() {
  ...
  useSWR('fetchGuaranteeProductServiceList', fetchGuaranteeProductServiceList);

  useEffect(() => {
    fetchGuaranteeProductServiceList();
  }, [fetchGuaranteeProductServiceList, valueFilter]);
  ...
  return (
    <div>
      <CMSCategory
        ...
        columns={columns}
        // refeshWhenNotValue={'fetchGuaranteeProductServiceList'}
      />
      <Modal
        styles={{
          mask: {
