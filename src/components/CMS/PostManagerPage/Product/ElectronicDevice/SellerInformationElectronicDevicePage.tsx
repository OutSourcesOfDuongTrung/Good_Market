...
export default function SellerInformationElectronicDevicePage() {
  ...
  const onFinish = async (e: any) => {
    await instanceAxios
      .patch(`/ElectronicDevice/seller-information/${currentID}/`, e)
      .then((res) => {
        form.resetFields();
        setOpenModalCreate(false);
        message.success('Đã cập nhật');
        mutate('fetchSellerInformationElectronicDeviceList');
      })
      .catch((err) => {
  ...
  const fetchDelete = async (id: number) => {
    await instanceAxios
      .delete(`/ElectronicDevice/seller-information/${id}/`)
      .then((res) => {
  ...
  const fetchSellerInformationElectronicDeviceList = useCallback(async () => {
    await instanceAxios
      .get(`/ElectronicDevice/seller-information/`, {
        params: {
  ...
  useSWR(
    'fetchSellerInformationElectronicDeviceList',
    fetchSellerInformationElectronicDeviceList
  );
  ...
  return (
    <div>
      <CMSCategory
        ...
        createAble={true}
        create={{
          url: '/ElectronicDevice/seller-information/',
          inputName: ['Name'],
          // body: { asdas: 'asdd' },
          onSucces(res) {
            mutate('fetchSellerInformationElectronicDeviceList');
