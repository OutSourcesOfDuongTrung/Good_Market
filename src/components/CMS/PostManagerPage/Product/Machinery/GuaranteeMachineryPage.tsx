...
export default function GuaranteeMachineryPage() {
  ...
  const onFinish = async (e: any) => {
    await instanceAxios
      .patch(`/machinery-equipment/guarantee/${currentID}/`, e)
      .then((res) => {
        form.resetFields();
        setOpenModalCreate(false);
        message.success('Đã cập nhật');
        mutate('fetchGuaranteeMachineryList');
      })
      .catch((err) => {
  ...
  const fetchDelete = async (id: number) => {
    await instanceAxios
      .delete(`/machinery-equipment/guarantee/${id}/`)
      .then((res) => {
  ...
  const fetchGuaranteeMachineryList = useCallback(async () => {
    await instanceAxios
      .get(`/machinery-equipment/guarantee/`, {
        params: {
  ...
  useSWR('fetchGuaranteeMachineryList', fetchGuaranteeMachineryList);

  useEffect(() => {
    fetchGuaranteeMachineryList();
  }, [fetchGuaranteeMachineryList]);
  // useEffect(() => {
