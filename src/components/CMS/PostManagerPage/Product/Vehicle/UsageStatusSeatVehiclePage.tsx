...
export default function UsageStatusSeatVehiclePage() {
  ...
  useSWR('fetchUsageStatusSeatVehicleList', fetchUsageStatusSeatVehicleList);

  useEffect(() => {
    fetchUsageStatusSeatVehicleList();
  }, [fetchUsageStatusSeatVehicleList]);
  // useEffect(() => {
