...
export default function CategoryVehiclePage() {
  ...
  useSWR('fetchCategoryVehicleList', fetchCategoryVehicleList);

  useEffect(() => {
    fetchCategoryVehicleList();
  }, [fetchCategoryVehicleList]);
  // useEffect(() => {
