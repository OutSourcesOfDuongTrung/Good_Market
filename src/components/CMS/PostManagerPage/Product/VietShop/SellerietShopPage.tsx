...
export default function SellerietShopPage() {
  ...
  useSWR('fetchSellerietShopList', fetchSellerietShopList);

  useEffect(() => {
    fetchSellerietShopList();
  }, [fetchSellerietShopList, valueFilter]);
  ...
  return (
    <div>
      <CMSCategory
        ...
        columns={columns}
        // refeshWhenNotValue={'fetchSellerietShopList'}
      />
      <Modal
        styles={{
          mask: {
