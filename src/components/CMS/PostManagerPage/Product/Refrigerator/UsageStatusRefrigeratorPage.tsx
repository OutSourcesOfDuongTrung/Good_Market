...
export default function UsageStatusRefrigeratorPage() {
  ...
  useSWR('fetchUsageStatusRefrigeratorList', fetchUsageStatusRefrigeratorList);

  useEffect(() => {
    fetchUsageStatusRefrigeratorList();
  }, [fetchUsageStatusRefrigeratorList]);
  // useEffect(() => {
